...
#WORKDIR /app1
#COPY MediQueryBot/ .  # Adjust this line to where your first bot's source code is located
...
#WORKDIR /app2
#COPY MediRequestBot/ .  # Adjust this line to where your second bot's source code is located
